jQuery(document).ready(function() {
  ...
  $.i18n().load({
    ...
    'es': {
      ...
      /* HERO */
      'hero-title': 'Creamos tu sitio web GRATUITO*',
      'hero-desc1': 'Lista en 36 Horas',
      'hero-desc2': 'Solamente Paga la Cuota de Mantenimiento Anual.',
      'hero-desc3': 'Incluye Mapa de Google, Chat en Vivo y Forma de Contacto.',
      'hero-desc4': 'Incrementa Ventas y Aumenta presencia Online',
      /* FORM */
      'form-title': 'Cuéntanos tu proyecto, un experto te atenderá',
      'form-desc': 'Para una cotización gratuita, llena la siguiente forma o llámanos al 55 22 59 68 98.',
