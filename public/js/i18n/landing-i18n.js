jQuery(document).ready(function() {
  ...
  $.i18n().load({
    'en': {
      ...
      'intro-modal-bundle4-bullet17': 'Payment using PayPal',
      ...
      'intro-modal-bundle4-bullet12': 'Up to @your.domain mail accounts',
      'intro-modal-bundle4-bullet10': 'Up to 5 contact forms',
      'intro-modal-bundle4-bullet11': 'Google Analytics integration',
      'intro-modal-bundle4-bullet5': '24/7 Technical support for 1 year',
      'intro-modal-bundle4-bullet6': 'Free domain registration (15USD maximum price)',
      'intro-modal-bundle4-bullet7': 'Optimized code making the page load faster',
      'intro-modal-bundle4-bullet8': '500MB storage',
    ...
    'es': {
      ...
      'intro-modal-bundle4-bullet17': 'Pago con PayPal',
      ...
      'intro-modal-bundle4-bullet12': '20 cuentas de correo @tu.dominio, ligadas a Gmail o Outlook',
      'intro-modal-bundle4-bullet10': '5 formularios de contacto',
      ...
      'intro-modal-bundle4-bullet8': '500MB de almacenamiento',
